# Learning & Un-learning: 기존의 낡은 지식과 습관을 잘 버려야 능력이 빨리 늘어난다

## Executive Summary

AI Agent와 Harness 같은 에이전틱 개발 플랫폼이 실무에 들어오면서, “새 도구를 어떻게 배울 것인가”보다 “기존 판단 습관을 어떻게 갱신할 것인가”가 더 큰 병목이 되었다.
...
에이전트와 하네스 플랫폼 도입에서 언러닝 대상이 되는 오개념은 두 계층으로 나뉜다. **A-세트**는 “에이전트 개념 자체”에 관한 근본 오개념이고, **B-세트**는 2025년 이후 MCP·자기교정 에이전트·바이브 코딩 확산과 함께 새롭게 관찰된 “운영·확장 방식”에 관한 오개념이다. 
