...
| Multi Agent System architecture | [docs/architecture/multi-agent-system.md](architecture/multi-agent-system.md) |
...
├── architecture/                             # Implementation-oriented architecture deep dives
