...
// NOTE: upstream gajae-code embeds the PUBLIC Antigravity installed-app OAuth
// client here (base64-encoded). Stripped from this course snapshot to satisfy
// GitHub secret scanning; restore from upstream gajae-code or supply your own
// to exercise the Antigravity login flow.
